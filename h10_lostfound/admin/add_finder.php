...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../bootstrap-4.4.1/css/bootstrap.min.css">
  	...
  	<script type="text/javascript">
  		function alertMsg(){
  			alert("finder added succesfully");
...
<body>
	...
	<span><marquee>This is the H10 Lost and Found. Any Lost and Found items can be documented here</marquee></span><br><br>
		<center><h4>Add Finder</h4><br></center>
		<div class="row">
			<div class="col-md-4"></div>
			<div class="col-md-4">
				<form action="" method="post">
					<div class="form-group">
						<label for="name">Finder Name:</label>
						<input type="text" class="form-control" name="finder_name" required>
					</div>
					<button type="submit" name="add_finder" class="btn btn-primary">Add Finder</button>
				</form>
			</div>
			<div class="col-md-4"></div>
		</div>
...
<?php
	if(isset($_POST['add_finder']))
	{
		$connection = mysqli_connect("localhost","root","");
		$db = mysqli_select_db($connection,"h10_lostfound");
		$query = "insert into finders values(null,'$_POST[finder_name]')";
		$query_run = mysqli_query($connection,$query);
